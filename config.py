...
OWNER_ID = int(getenv("OWNER_ID", 8263141024))
...
# Git
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/shoaib910385/MysicVens")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv("GIT_TOKEN", None)

# Support
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/vthsupport")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/vth_supportchat")
...
# Image URLs
START_IMG_URL = getenv("START_IMG_URL", "https://files.catbox.moe/szq7a3.jpg")
PING_IMG_URL = getenv("PING_IMG_URL", "https://files.catbox.moe/szq7a3.jpg")
